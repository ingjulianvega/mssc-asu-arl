...
public class ErrorCodeMessages {
    ...
    public static final String ARL_NOT_FOUND_API_CODE = "401";
    public static final String ARL_NOT_FOUND_ERROR = "ARL_NOT_FOUND";
    public static final String ARL_NOT_FOUND_MESSAGE = "No se encontró el método de administración";
    public static final String ARL_NOT_FOUND_SOLUTION = "Verifique los datos";
